...
$("#category").change(onPlaceChanged);
function onPlaceChanged() {
  search_for = $("#category").children("option:selected").val();
  ...
  if (place){
    ...
    }else if (search_for == "cafe") {
      searchPlaces(['cafe']);
    }else if (search_for == "takeaway") {
      searchPlaces(['meal_takeaway']);
    }else if (search_for == "delivery") {
      searchPlaces(['meal_delivery']);
    }
